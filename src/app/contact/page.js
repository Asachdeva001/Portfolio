          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full px-6 py-3 rounded-lg transition-colors duration-300 disabled:opacity-60 flex items-center justify-center gap-2 font-semibold shadow-md"
          ...
          >
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <a href="mailto:your.email@example.com" className="text-gray-300 hover:text-[#2D4F4A]">
                    ashisach001@gmail.com
                  </a>
                </div>
                <div className="flex items-center space-x-3">
                  <svg
                  ...
                  <span className="text-gray-200">Chandigarh, India</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  href="https://github.com/Asachdeva001"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-200 hover:text-[#2D4F4A] transition-colors"
                >
                ...
                <a
                  href="https://www.linkedin.com/in/aashish-sachdeva-6b1943281/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-200 hover:text-[#2D4F4A] transition-colors"
                >
